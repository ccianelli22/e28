...
<div class="flex flex-col ">
    <div class="bg-orange-500">
        <div class="grid grid-cols-3 text-center">
            ...
            <span class=" col-span-1 font-semibold text-5xl">|</span>
            <!-- COMPUTER INFORMATION -->
            <div class="col-span-1">
                <h1 class="font-semibold text-5xl">Computer</h1>
                <h3 class="font-semibold text-3xl">
        ...
        <div class="flex flex-row items-baseline justify-evenly">
            <button class=" rounded m-2 p-1 hover:bg-black hover:text-orange-500 transition-colors duration-300">
                <router-link to="/">GO HOME</router-link>
            </button>
            <button id="history" class=" rounded m-2 p-1 hover:bg-black hover:text-orange-500 transition-colors duration-300" @click="modalFunc.openModal">
                History
            </button>
        </div>
    </div>
